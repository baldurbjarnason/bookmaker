...
describe 'BookDir',
  () ->
    describe '#loadBookDir',
      () ->
        it 'Loads the book from a bookdir',
          () ->
            ...
            book.chapters[1].html.should.equal('<h1 id="markdown">Markdown</h1>\n<p class="noindent" id="p-1">Test</p>\n')
            ...
            book.chapters[4].html.should.equal('<h1 id="id1">1</h1>\n<p class="noindent" id="p-1">Test</p>\n')
            book.assets.root.should.equal('test/files/bookdir/')
            book.assets.assetsPath.should.equal('assets/')
            book.meta.landmarks[0].type.should.equal 'bodymatter'